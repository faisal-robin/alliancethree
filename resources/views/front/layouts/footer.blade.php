            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span style="color:#82ae46" class="icon icon-phone"></span><span class="text">{{$company_info->phone_1}}</span></a></li>
	                <li><a href="#"><span style="color:#82ae46" class="icon icon-envelope"></span><span class="text">{{$company_info->email}}</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
